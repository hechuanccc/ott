            ...
            this.opt = {
                setup: function (editor) {
                    ...
                    editor.on('SetContent', function () {
                        ...
                        vm.myModel = vm._currentState = editor.getContent()
                        vm.$emit('change-model', vm.myModel, vm.name)
                    })
                    editor.on('blur', function () {
                        vm.myModel = vm._currentState = editor.getContent({format: 'html'})
                        vm.$emit('change-model', vm.myModel, vm.name)
                    })
                },
                mode: 'exact',
